...
Original file is located at
    https://colab.research.google.com/drive/1-fqvUDVIJzRE0gQYUM_pmNN_FyVixwJf
"""
...
filename = '/content/DT_model.pkl'
loaded_model = pickle.load(open(filename, 'rb'))
df = pd.read_csv("/content/Clustered_Customer_Data.csv")
# st.set_option('deprecation.showPyplotGlobalUse', False) # This line is no longer needed and causes the error. Remove it.
...
if submitted:
    ...
    for c in cluster_df1.drop(['Cluster'],axis=1):
        ...
        # plt.show() # Remove this line as it's not needed in Streamlit
